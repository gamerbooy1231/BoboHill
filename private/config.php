<?php
	...
	$serverName = ($_SERVER['HTTP_HOST'] == 'brickplanet.com' || $_SERVER['HTTP_HOST'] == 'www.brickplanet.com' || $_SERVER['HTTP_HOST'] == 'test.brickplanet.com' || $_SERVER['HTTP_HOST'] == 'cdn.brickplanet.com') ? 'https://'.$_SERVER['HTTP_HOST'] : NULL;
	if (!$serverName) { header('Location: https://www.brickplanet.com/'); die; }
	$cdnName = 'https://cdn.brickplanet.com/';
	$adminFolder = 'newadmin';
	$_SERVER['REMOTE_ADDR'] = $_SERVER['HTTP_CF_CONNECTING_IP'];
	$UserIP = $_SERVER['HTTP_CF_CONNECTING_IP'];
	$CSSFile = ($serverName == 'https://brickplanet.com') ? 'test-style.css' : 'dark-style.css?r=4';
	$JSFile = ($serverName == 'https://brickplanet.com') ? 'main.js' : 'ffc7473dbb6609f5f6251e9a58e7c1af.js?r=3';
	...
	if ($cache->get($UserIP.'IPBanned') > 0) {
		die("We're sorry, this IP Address has been banned due to abuse. If you wish to appeal, please contact us at moderation@brickplanet.com.");
	}
	...
	if ($serverName == 'https://www.brickplanet.com' && $SiteSettings->Maintenance == 1 && !isset($_SESSION['GlobalSecurityToken']) || $serverName == 'https://test.brickplanet.com' && !isset($_SESSION['GlobalSecurityToken'])) {
	...
	function isProfanity($Text) {
	    ...
	    $WhitelistDomains = array('brickplanet.com', 'youtube.com', 'twitter.com', 't.co', 'google.com', 'discord.gg', 'discordapp.com');
	...
	function linkify($string) {
		...
		$rexProtocol = '(https?://)?';
		$rexDomain   = '(www.brickplanet.me|brickplanet.me|jobs.brickplanet.com|helpme.brickplanet.com|www.brickplanet.com|brickplanet.com|blog.brickplanet.com)';
	...
	if ($_SERVER['HTTP_HOST'] == 'amazon.brickplanet.com') {
		//echo 'amazon.brickplanet.com';
	}

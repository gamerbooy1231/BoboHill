...
<html lang="en" prefix="og: http://ogp.me/ns#">
	...
	<?php
			...
			<div class="top-bar-left">
				<div class="grid-x align-middle grid-margin-x">
					...
					<div class="shrink cell menu-logo">
						<a href="'.$serverName.'">
							<img src="'.$cdnName.'assets/images/bp-logo.png" class="show-for-large">
						...
						<ul class="menu align-middle">
							...
							if (!$AUTH) {
								...
								<li class="menu-link avatar-preview">
									<a data-toggle="user-dropdown-all"><div class="menu-avatar-preview-thumbnail" style="background-image:url('.$cdnName . $myU->AvatarURL.'-thumb.png);background-size:cover;"></div></a>
								</li>
								';
							}
							echo '
			...
			<div id="user-dropdown-all" data-toggler data-animate="fade-in fade-out" style="display:none;z-index: 100;" class="fast">
				...
				<div class="user-dropdown" id="user-dropdown">
					<div class="dropdown-header">
						<div class="grid-x align-middle grid-margin-x">
							<div class="shrink cell no-margin">
								<div class="avatar-preview-thumbnail" style="background-image:url('.$cdnName.''.$myU->AvatarURL.'-thumb.png);background-size:cover;"></div>
							</div>
							<div class="auto cell">
		...
		<ul>
			...
			<li><a href="'.$serverName.'/groups/"'; if ($page == 'groups') { $MobileDesktopHTML .= ' class="active"'; } $MobileDesktopHTML .= '><i class="material-icons">group</i><span>Groups</span></a></li>
			...
			if ($AUTH) {
				$MobileDesktopHTML .= '
				<li><a href="'.$serverName.'/upgrade/"'; if ($page == 'upgrade') { $MobileDesktopHTML .= ' class="active"'; } $MobileDesktopHTML .= '><i class="material-icons">shopping_basket</i><span>Upgrade</span></a></li>
				<li><a href="'.$serverName.'/creator-area/"'; if ($page == 'creator-area') { $MobileDesktopHTML .= ' class="active"'; } $MobileDesktopHTML .= '><i class="material-icons">library_add</i><span>Creator Area</span></a></li>
				';
			}
			echo '
		</ul>
